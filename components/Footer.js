               ...
               <StyledUl style={ { "align-items": "center", } }>
                  ...
                  <div>
                     <Styleddiv >
                        ...
                        <StyledLink href={ 'https://www.facebook.com/nourr.xd' } target="_blank" aria-label="Facebook profile">
                           <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 24 24" id="facebook-f"><path fill="#026EFF" d="M15.12,5.32H17V2.14A26.11,26.11,0,0,0,14.26,2C11.54,2,9.68,3.66,9.68,6.7V9.32H6.61v3.56H9.68V22h3.68V12.88h3.06l.46-3.56H13.36V7.05C13.36,6,13.64,5.32,15.12,5.32Z"></path></svg>
                        </StyledLink>
                        <StyledLink href={ 'https://wa.link/vuqau2' } target="_blank" aria-label="whatsapp profile">
                  ...
                  <div style={ { "font-size": "12px", "color": "#8888" ,textAlign:"center"} }> ©2022-2023 <br/> All Rights Reserved</div>
               </StyledUl>
            </StyledFooter>
         </Center>
      </BG>
